...
// Update a user in Firebase - accepts id and partial data
export async function updateUsuarioInFirebase(id: string, data: any) {
  try {
...
// Update a question in Firebase - accepts id and partial data
export async function updatePreguntaInFirebase(preguntaId: string, data: any) {
  try {
